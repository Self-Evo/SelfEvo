...
MODE = "test"
RE10K_METAROOT = "/mnt/data/haven_berkeley/projects/video_data/re10k/metadata"
OUTPUT_ROOT = "/mnt/data/haven_berkeley/projects/video_data/re10k/re10k/test"
SEQUENCE_LIST_FILE = "/mnt/data/haven_berkeley/projects/video_data/Pi3/datasets/sequences/re10k_test_1800.txt"
...
for seq in tqdm(sequence_list):
    ...
    if not osp.exists(first_image_path):
        tqdm.write(f"[skip] first image not found: {first_image_path}")
        continue
